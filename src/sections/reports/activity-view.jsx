...
//                   >
//                     Changed Fields:{' '}
//                     {Object.keys(activity.changed_fields).length}
//                   </Typography>
//                 )}
//             </CardContent>
//           </Card>
                  ...
                  <Card key={item.id} variant="outlined" sx={{ borderColor: 'error.light' }}>
                    <CardContent>
                      <Stack direction="row" spacing={2} alignItems="center">
                        ...
                        />
                        <Box>
                          <Typography fontWeight={600}>{item.media_type}</Typography>
